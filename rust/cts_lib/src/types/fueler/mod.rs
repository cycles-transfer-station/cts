...
pub const FUEL_TOPUP_TRIGGER_THRESHOLD: u128 = 50 * TRILLION; // canisters that go below this threshold will be topped up.
pub const FUEL_TOPUP_TO_MINIMUM_BALANCE: u128 = 100 * TRILLION; // how much to top up canisters that went below the threshold.
