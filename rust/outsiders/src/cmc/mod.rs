// dfinity/ic commit: b9a20425f94eb1433385a7ed0c59c41095c17b7b, module-hash: 58ee30cb6cb074dc066b7e8dfc78d8e2b1a9e97a48e3, nns-proposal: 130396
...
pub enum ExchangeRateCanister { Set(Principal), Unset }
...
impl Service {
  pub async fn create_canister(&self, arg0: CreateCanisterArg) -> Result<(CreateCanisterResult,)> {
  ...
  pub async fn get_principals_authorized_to_create_canisters_to_subnets(&self) -> Result<(PrincipalsAuthorizedToCreateCanistersToSubnetsResponse,)> {
  ...
  pub async fn notify_mint_cycles(&self, arg0: NotifyMintCyclesArg) -> Result<(NotifyMintCyclesResult,)> {
