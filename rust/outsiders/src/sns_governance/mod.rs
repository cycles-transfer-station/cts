...
impl Service {
  ...
  pub async fn fail_stuck_upgrade_in_progress(&self, arg0: FailStuckUpgradeInProgressArg) -> Result<(FailStuckUpgradeInProgressRet,)> {
  ...
  pub async fn get_maturity_modulation(&self, arg0: GetMaturityModulationArg) -> Result<(GetMaturityModulationResponse,)> {
  ...
  pub async fn get_running_sns_version(&self, arg0: GetRunningSnsVersionArg) -> Result<(GetRunningSnsVersionResponse,)> {
    ic_cdk::call(self.0, "get_running_sns_version", (arg0,)).await
  }
  pub async fn get_sns_initialization_parameters(&self, arg0: GetSnsInitializationParametersArg) -> Result<(GetSnsInitializationParametersResponse,)> {
